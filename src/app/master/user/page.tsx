...
export default function User() {
  ...
  console.log("SESSION USER PAGE ", data);
  ...
  useEffect(() => {
    console.log("SESSIONNNNNNNN ", data);
    getAllUser();
  }, [page, limit, search]);
      ...
      <Flex vertical gap={10}>
        <div>
          ...
          <Form.Item
            ...
            style={{ marginBottom: errors["name"] ? 0 : 0 }}
          >
        ...
        <div>
          ...
          <Form.Item
            validateStatus={errors["division_id"] ? "error" : ""}
            help={errors["division_id"] ? errors["division_id"][0] : ""}
            style={{ marginBottom: errors["division_id"] ? 0 : 0 }}
          >
            <Select
              showSearch
        ...
        <div>
          ...
          <Form.Item
            ...
            style={{ marginBottom: errors["password_confirmation"] ? 0 : 0 }}
          >
            <Input
              type="password"
